...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Chantier : {{ $chantier->titre }} - Client : {{ $chantier->client->name }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form action="{{ route('chantiers.factures.store', $chantier) }}" method="POST" x-data="factureForm()">
            @csrf
            ...
            <div class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <textarea name="description" 
                                          id="description" 
                                          rows="3" 
                                          class="form-textarea">{{ old('description', $facture->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="flex items-center justify-between bg-white px-6 py-4 rounded-xl shadow-lg">
                    <a href="{{ route('chantiers.factures.index', $chantier) }}" 
