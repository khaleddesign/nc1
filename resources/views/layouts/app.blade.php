            ...
            <nav class="bg-white shadow-sm border-b border-gray-200">
                ...
                <div x-show="mobileMenuOpen" class="sm:hidden border-t border-gray-200">
                    <div class="pt-2 pb-3 space-y-1">
                        <a href="{{ route('dashboard') }}" class="block pl-3 pr-4 py-2 text-gray-600 hover:text-gray-900">Dashboard</a>
                        <a href="{{ route('chantiers.index') }}" class="block pl-3 pr-4 py-2 text-gray-600 hover:text-gray-900">Chantiers</a>
                        @can('admin-only')
                            <a href="{{ route('admin.users') }}" class="block pl-3 pr-4 py-2 text-gray-600 hover:text-gray-900">Admin</a>
                        @endcan
                    </div>
                </div>
            </nav>
