...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <nav class="flex items-center space-x-2 text-sm text-gray-500">
                        ...
                        <a href="{{ route('chantiers.devis.show', [$chantier, $devis]) }}" class="hover:text-gray-700">{{ $devis->numero }}</a>
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form action="{{ route('chantiers.devis.update', [$chantier, $devis]) }}" method="POST" x-data="devisEditForm()">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <textarea name="description" 
                                          id="description" 
                                          rows="3" 
                                          class="form-textarea @error('description') border-red-300 @enderror">{{ old('description', $devis->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       class="form-input @error('delai_realisation') border-red-300 @enderror"
                                       min="1">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       class="form-input @error('modalites_paiement') border-red-300 @enderror"
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <textarea name="conditions_generales" 
                                          ...
                                          rows="4" 
                                          class="form-textarea @error('conditions_generales') border-red-300 @enderror"
                ...
                <div class="flex items-center justify-between bg-white px-6 py-4 rounded-xl shadow-lg">
                    <a href="{{ route('chantiers.devis.show', [$chantier, $devis]) }}" 
