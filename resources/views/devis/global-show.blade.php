                        ...
                        <ol class="flex items-center space-x-4">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    @else
                                        <span class="ml-4 text-sm font-medium text-gray-500">Devis prospect</span>
                                    @endif
                                </div>
                            </li>
                            <li>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <dd class="mt-1">
                         @php
    $statutValue = is_object($devis->statut) ? $devis->statut->value : $devis->statut;
@endphp
<span class="badge bg-blue-100 text-blue-800">
    {{ ucfirst($statutValue) }}
            ...
            {{-- Colonne latérale --}}
            <div class="space-y-6">
                {{-- Informations du chantier ou prospect --}}
                @if($devis->chantier)
                    {{-- Section chantier --}}
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                @else
                    {{-- Section prospect --}}
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Informations du prospect</h3>
                        <div class="space-y-3">
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Nom</dt>
                                <dd class="mt-1 text-sm text-gray-900 font-medium">{{ $devis->client_info['nom'] ?? 'N/A' }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Email</dt>
                                <dd class="mt-1">
                                    @if(!empty($devis->client_info['email']))
                                        <a href="mailto:{{ $devis->client_info['email'] }}" 
                                           class="text-blue-600 hover:text-blue-800 text-sm">
                                            {{ $devis->client_info['email'] }}
                                        </a>
                                    @else
                            ...
                            @if(!empty($devis->client_info['telephone']))
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Téléphone</dt>
                                    <dd class="mt-1">
                                        <a href="tel:{{ $devis->client_info['telephone'] }}" 
                                           class="text-blue-600 hover:text-blue-800 text-sm">
                                            {{ $devis->client_info['telephone'] }}
                                        </a>
                                    </dd>
                                </div>
                            @endif
                            @if(!empty($devis->client_info['adresse']))
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Adresse</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $devis->client_info['adresse'] }}</dd>
                                </div>
                            @endif
                        </div>
                    </div>
